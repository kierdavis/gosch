...
func (d *Decoder) decodeObjects() (objects []Object, err error) {
    ...
    for {
        ...
        switch recordType {
        case "L": object = new(Line)
        case "G": object = new(Picture)
        case "B": object = new(Box)
        case "V": object = new(Circle)
        case "A": object = new(Arc)
        case "T": object = new(Text)
        case "N": object = new(Net)
        case "U": object = new(Bus)
        case "P": object = new(Pin)
        case "C": object = new(Component)
        case "H": object = new(Path)
